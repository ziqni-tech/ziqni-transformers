...
trait CLWebhookTransformer {
  ...
  /**
    ...
    * @param competitionLabsApi The CompetitionLabs API
    */
  def onAchievementRewardIssued(settings: WebhookSettings, achievementId: String, memberId: String, awardId: String, competitionLabsApi: CompetitionLabsApiExt): Unit = {}
}
