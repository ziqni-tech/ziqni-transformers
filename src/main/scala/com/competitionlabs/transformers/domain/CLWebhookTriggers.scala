...
object CLWebhookTriggers {
	...
	case class onAchievementRewardIssuedTrigger(accountId:String, achievementId: String, memberId: String, awardId: String) extends Serializable with WebhookTransformerTrigger
