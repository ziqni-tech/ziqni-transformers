...
trait ZiqniMqTransformer {
	...
	/**
		...
		* @param ziqniTransformerEventBus
		*/
	def init(ziqniApi: ZiqniApi, ziqniTransformerInfo:ZiqniTransformerInfo, initEventBus: (EventbusAddress, EventbusGroup) => ZiqniTransformerEventBus): Unit = {}
}
